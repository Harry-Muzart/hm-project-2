...
{
    public sealed partial class NatureReviewsNeuroscienceDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public NatureReviewsNeuroscienceDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new NatureReviewsNeuroscienceConfig());
