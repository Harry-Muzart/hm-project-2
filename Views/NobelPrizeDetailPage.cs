...
{
    public sealed partial class NobelPrizeDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public NobelPrizeDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new NobelPrizeConfig());
