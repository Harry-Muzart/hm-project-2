...
{
    public sealed partial class ScienceOfLearningNPJDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public ScienceOfLearningNPJDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new ScienceOfLearningNPJConfig());
