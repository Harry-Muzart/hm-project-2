...
{
    public sealed partial class NatureNeuroscienceCurrentDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public NatureNeuroscienceCurrentDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new NatureNeuroscienceCurrentConfig());
