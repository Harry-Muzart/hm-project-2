...
{
    public sealed partial class ScienceDailyHealthDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public ScienceDailyHealthDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new ScienceDailyHealthConfig());
