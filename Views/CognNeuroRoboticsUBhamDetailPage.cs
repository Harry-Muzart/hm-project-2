...
{
    public sealed partial class CognNeuroRoboticsUBhamDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public CognNeuroRoboticsUBhamDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new CognNeuroRoboticsUBhamConfig());
