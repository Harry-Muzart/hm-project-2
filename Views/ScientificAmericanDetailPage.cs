...
{
    public sealed partial class ScientificAmericanDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public ScientificAmericanDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new ScientificAmericanConfig());
