...
{
    public sealed partial class ComputationalNeurosciDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public ComputationalNeurosciDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new ComputationalNeurosciConfig());
