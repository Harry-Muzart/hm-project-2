...
{
    public class NatureNeuroscienceAOPConfig : SectionConfigBase<RssDataConfig, RssSchema>
    {
        ...
        public override RssDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://feeds.nature.com/neuro/rss/aop")
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("NatureNeuroscienceAOPListPage");
            }
        }
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("NatureNeuroscienceAOPDetailPage", true);
                    }
                };
            }
        }
        ...
        {
            get { return "Nature Neuroscience AOP"; }
        }
