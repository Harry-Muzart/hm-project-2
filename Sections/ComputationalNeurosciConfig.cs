...
{
    public class ComputationalNeurosciConfig : SectionConfigBase<RssDataConfig, RssSchema>
    {
        ...
        public override RssDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://www.nature.com/subjects/computational-neuroscience.rss")
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("ComputationalNeurosciListPage");
            }
        }
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("ComputationalNeurosciDetailPage", true);
                    }
                };
            }
        }
        ...
        {
            get { return "Computational Neurosci"; }
        }
