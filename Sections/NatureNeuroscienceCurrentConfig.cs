...
{
    public class NatureNeuroscienceCurrentConfig : SectionConfigBase<RssDataConfig, RssSchema>
    {
        ...
        public override RssDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://feeds.nature.com/neuro/rss/current")
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("NatureNeuroscienceCurrentListPage");
            }
        }
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "Nature Neuroscience Current",
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("NatureNeuroscienceCurrentDetailPage", true);
                    }
                };
            }
        }
        ...
        {
            get { return "Nature Neuroscience Current"; }
        }
