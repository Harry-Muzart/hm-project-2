...
{
    public class CognNeuroRoboticsUBhamConfig : SectionConfigBase<RssDataConfig, RssSchema>
    {
        ...
        public override RssDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://www.birmingham.ac.uk/research/activity/cncr/news/index.aspx?NewsListingOrig_SyndicationType=1")
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("CognNeuroRoboticsUBhamListPage");
            }
        }
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                ...
                {
                    Title = "Cogn Neuro-Robotics U-Bham",
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("CognNeuroRoboticsUBhamDetailPage", true);
                    }
                };
            }
        }
        ...
        {
            get { return "Cogn Neuro-Robotics U-Bham"; }
        }
